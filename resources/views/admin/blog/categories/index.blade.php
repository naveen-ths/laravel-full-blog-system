                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('admin.blog.categories.show', $category) }}" class="text-indigo-600 hover:text-indigo-900">
                                                    View
                                                </a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                            No categories found. <a href="{{ route('admin.blog.categories.create') }}" class="text-blue-600 hover:text-blue-900">Create your first category</a>.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
