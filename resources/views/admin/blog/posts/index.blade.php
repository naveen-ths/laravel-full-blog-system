                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.blog.posts.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select name="category" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                            No posts found. <a href="{{ route('admin.blog.posts.create') }}" class="text-blue-600 hover:text-blue-900">Create your first post</a>.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
